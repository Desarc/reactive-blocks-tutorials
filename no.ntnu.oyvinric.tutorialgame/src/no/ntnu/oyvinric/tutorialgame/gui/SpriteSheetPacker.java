...
public class SpriteSheetPacker {
	...
	public static void main(String[] args) {
		String[] texturePacks = {"fullscreens", "game-tiles", "tileset", "malcolm", "lisa", "andrew", "wolf", "user-interface", "intro", "misc", "intro-level-01", "intro-level-02", "intro-level-03", "intro-level-04"};
